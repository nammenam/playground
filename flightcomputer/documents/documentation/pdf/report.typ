...
#show heading: t => { set text(font:"TeX Gyre Bonum")
  t
}

// title
#text(weight:900,size:30pt,font:"TeX Gyre Bonum",
smallcaps("KON-TIKI FINAL TECHNICAL REPORT: COMPASS")
)
...
$ 
  &accent(mbf(x),dot) = mbf(f)(bold(x),bold(u)) + bold(w)_d\
...
$
  &accent(bold(x),dot) = mbf(F x + B u ) + bold(w)_d\
  &accent(bold(y),hat) = mbf(H x + D u + w)_n
$
...
$
  bold(F)_(v q) = \
  2 mat(
    q_1a_x+q_3a_z-q_4a_y,q_2a_x+q_3a_y+q_4a_z,q_1a_z-q_3a_x+q_2a_y,q_4a_x-q_1a_y+q_2a_z;
    q_1a_y+q_4a_x-q_2a_z,q_3a_x-q_2a_y-q_1a_z,q_3a_y+q_2a_x+q_4a_z,q_3a_z-q_4a_y+q_1a_x;
    q_1a_z+q_2a_y-q_3a_x,q_4a_x-q_2a_z+q_1a_y,q_4a_y-q_3a_z-q_1a_x,q_4a_z+q_2a_x+q_3a_y;
  )dif t
$
$
...
$
  bold(H)_q =\
  2 mat(
    q_1psi_x+q_3psi_z-q_4psi_y,q_2psi_x+q_3psi_y+q_4psi_z,q_1psi_z-q_3psi_x+q_2psi_y,q_4psi_x-q_1psi_y+q_2psi_z;
    q_1psi_y+q_4psi_x-q_2psi_z,q_3psi_x-q_2psi_y-q_1psi_z,q_3psi_y+q_2psi_x+q_4psi_z,q_3psi_z-q_4psi_y+q_1psi_x;
    q_1psi_z+q_2psi_y-q_3psi_x,q_4psi_x-q_2psi_z+q_1psi_y,q_4psi_y-q_3psi_z-q_1psi_x,q_4psi_z+q_2psi_x+q_3psi_y;
  )
$
...
$
  J = E[bold(x) - accent(bold(x),hat)]^T Q E[bold(x) - accent(bold(x),hat)] + E[bold(y) - accent(bold(x),hat)]^T R E[bold(y) - accent(bold(x),hat)]
$
