...
design_libs=(xilinx_vip axi_infrastructure_v1_1_0 axi_vip_v1_1_22 processing_system7_vip_v1_0_24 xil_defaultlib)
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../platform.gen/sources_1/bd/ps/ipshared/ec67/hdl" +incdir+"../../../../platform.gen/sources_1/bd/ps/ipshared/9a25/hdl" +incdir+"../../../../../../../../.local/share/vivado/2025.2/data/rsb/busdef" +incdir+"/home/brage/.local/share/vivado/2025.2/data/xilinx_vip/include" \
  ...
  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"../../../../platform.gen/sources_1/bd/ps/ipshared/ec67/hdl" +incdir+"../../../../platform.gen/sources_1/bd/ps/ipshared/9a25/hdl" +incdir+"../../../../../../../../.local/share/vivado/2025.2/data/rsb/busdef" +incdir+"/home/brage/.local/share/vivado/2025.2/data/xilinx_vip/include" \
  ...
  vlogan -work axi_vip_v1_1_22 $vlogan_opts -sverilog +incdir+"../../../../platform.gen/sources_1/bd/ps/ipshared/ec67/hdl" +incdir+"../../../../platform.gen/sources_1/bd/ps/ipshared/9a25/hdl" +incdir+"../../../../../../../../.local/share/vivado/2025.2/data/rsb/busdef" +incdir+"/home/brage/.local/share/vivado/2025.2/data/xilinx_vip/include" \
  "../../../../platform.gen/sources_1/bd/ps/ipshared/b16a/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work processing_system7_vip_v1_0_24 $vlogan_opts -sverilog +incdir+"../../../../platform.gen/sources_1/bd/ps/ipshared/ec67/hdl" +incdir+"../../../../platform.gen/sources_1/bd/ps/ipshared/9a25/hdl" +incdir+"../../../../../../../../.local/share/vivado/2025.2/data/rsb/busdef" +incdir+"/home/brage/.local/share/vivado/2025.2/data/xilinx_vip/include" \
  "../../../../platform.gen/sources_1/bd/ps/ipshared/9a25/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../platform.gen/sources_1/bd/ps/ipshared/ec67/hdl" +incdir+"../../../../platform.gen/sources_1/bd/ps/ipshared/9a25/hdl" +incdir+"../../../../../../../../.local/share/vivado/2025.2/data/rsb/busdef" +incdir+"/home/brage/.local/share/vivado/2025.2/data/xilinx_vip/include" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/brage/embedded/z7nano/FPGA/platform/platform.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key ps_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc ps_simv.daidir vcs_lib c.obj)
