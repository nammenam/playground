...
#
# Script generated by Vivado on Sat May 23 17:00:08 CEST 2026
...
design_libs_elab="-libname xilinx_vip -libname axi_infrastructure_v1_1_0 -libname axi_vip_v1_1_22 -libname processing_system7_vip_v1_0_24 -libname xil_defaultlib -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip axi_infrastructure_v1_1_0 axi_vip_v1_1_22 processing_system7_vip_v1_0_24 xil_defaultlib)
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../platform.gen/sources_1/bd/ps/ipshared/ec67/hdl" +incdir+"../../../../platform.gen/sources_1/bd/ps/ipshared/9a25/hdl" +incdir+"../../../../../../../../.local/share/vivado/2025.2/data/rsb/busdef" +incdir+"/home/brage/.local/share/vivado/2025.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../../platform.gen/sources_1/bd/ps/ipshared/ec67/hdl" +incdir+"../../../../platform.gen/sources_1/bd/ps/ipshared/9a25/hdl" +incdir+"../../../../../../../../.local/share/vivado/2025.2/data/rsb/busdef" +incdir+"/home/brage/.local/share/vivado/2025.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_vip_v1_1_22 $xmvlog_opts -sv +incdir+"../../../../platform.gen/sources_1/bd/ps/ipshared/ec67/hdl" +incdir+"../../../../platform.gen/sources_1/bd/ps/ipshared/9a25/hdl" +incdir+"../../../../../../../../.local/share/vivado/2025.2/data/rsb/busdef" +incdir+"/home/brage/.local/share/vivado/2025.2/data/xilinx_vip/include" \
  "../../../../platform.gen/sources_1/bd/ps/ipshared/b16a/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work processing_system7_vip_v1_0_24 $xmvlog_opts -sv +incdir+"../../../../platform.gen/sources_1/bd/ps/ipshared/ec67/hdl" +incdir+"../../../../platform.gen/sources_1/bd/ps/ipshared/9a25/hdl" +incdir+"../../../../../../../../.local/share/vivado/2025.2/data/rsb/busdef" +incdir+"/home/brage/.local/share/vivado/2025.2/data/xilinx_vip/include" \
  "../../../../platform.gen/sources_1/bd/ps/ipshared/9a25/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../platform.gen/sources_1/bd/ps/ipshared/ec67/hdl" +incdir+"../../../../platform.gen/sources_1/bd/ps/ipshared/9a25/hdl" +incdir+"../../../../../../../../.local/share/vivado/2025.2/data/rsb/busdef" +incdir+"/home/brage/.local/share/vivado/2025.2/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.ps xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.ps -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/brage/embedded/z7nano/FPGA/platform/platform.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log ps_sc.so .tmp_log xcelium_lib waves.shm c.obj)
